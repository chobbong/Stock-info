import pymysql, requests, json, calendar, time
...
class DBUpdater:
    ...
    def __init__(self):
        ...
        self.conn = pymysql.connect (host='localhost', user='root', password='Whdbstj77!', db='INVESTAR', charset='utf8')
    ...
    def update_comp_info(self):
        """종목코드를 company-info 테이블에 업데이트한 후 딕셔너리에 저장"""
    ...
    def update_daily_price(self, pages_to_fetch):
        """KRX 상장법인의 주식 시세를 네이버로부터 읽어서 D8에 업데이트"""
    ...
    def execute_daily(self):
        """실행 즉시 및 매일 오후 다섯시에 daily-price 테이블 업데이트"""
        self.update_comp_info() 
        ...
        else: tmnext = tmnow.replace(day=tmnow.day+1, hour=17, minute=0, second=0) 
        tmdiff = tmnext - tmnow 
        secs = tmdiff.seconds
